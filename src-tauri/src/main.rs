...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            browse_folder, browse_file, read_text_file, path_exists, export_file, validate_pat, validate_pat_scopes, test_site_auth,
            ...
            get_pr_files, get_file_diff,            list_sql_packages, kill_running_script, reset_git_credentials, is_admin, open_url, open_file, scan_local_sites, scan_enablon_instances, list_instance_sites, get_as_version, run_instance_action, git_preview,
